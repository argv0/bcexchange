...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/bcexchange/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/bcexchange/lib;)
...
COMBO_PLT = $(HOME)/.bcexchange_combo_dialyzer_plt
